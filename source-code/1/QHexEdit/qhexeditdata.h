...
class QHexEditData : public QObject
{
    ...
    public:
        ...
        {
            public:
                ReplaceCommand(qint64 pos, qint64 len, const QByteArray& ba, QHexEditData* owner, QUndoCommand* parent = 0): AbstractCommand(pos, owner, parent), _len(len), _data(ba), _remcmd(0), _inscmd(0) { }
    ...
    private:
        ...
        QHexEditData::ModifiedItem *modifiedItem(qint64 pos, qint64 *datapos = 0, int* index = 0);
